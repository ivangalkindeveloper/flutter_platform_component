    ...
    return FCScaffold(
      ...
      body: FCListView(
        children: [
          ...
          FCBlueDarkPINField(length: 4),
          SizedBox(height: size.s16 / 2),
          FCGreenDarkPINField(length: 4),
          SizedBox(height: size.s16 / 2),
          ...
          SizedBox(height: size.s16 / 2),
          FCBluePINField(length: 4),
          SizedBox(height: size.s16 / 2),
          FCGreenPINField(length: 4),
          SizedBox(height: size.s16 / 2),
          ...
          SizedBox(height: size.s16),
          FCBlueLightPINField(length: 4),
          SizedBox(height: size.s16 / 2),
          FCGreenLightPINField(length: 4),
          SizedBox(height: size.s16 / 2),
          ...
          SizedBox(height: size.s16 / 2),
          FCYellowLightPINField(length: 4),
        ],
      ),
    );
  }
