...
void main() {
  ...
  testWidgets('Verify that "useRootNavigator: false" uses the correct navigator',
    ...
    await tester.pumpWidget(createRootNavigatorTest(
        appKey: appKey, nestedNavigatorKey: nestedNavigatorKey, useRootNavigator: false));

    await tester.tap(find.text('Closed'));
    await tester.pumpAndSettle();

    expect(find.descendant(of: find.byKey(appKey), matching: find.text('Opened')),
        findsOneWidget);
  ...
  testWidgets('Verify that "useRootNavigator: true" uses the correct navigator',
    ...
    await tester.pumpWidget(createRootNavigatorTest(
        appKey: appKey, nestedNavigatorKey: nestedNavigatorKey, useRootNavigator: true));
  ...
  testWidgets('Verify correct opened size  when "useRootNavigator: true"',
    ...
    expect(
        tester.getSize(find.text('Opened')), equals(tester.getSize(find.byKey(appKey))));
  });
