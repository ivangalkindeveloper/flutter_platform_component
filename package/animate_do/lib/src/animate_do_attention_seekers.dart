...
class _BounceState extends State<Bounce> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    animationUp = Tween<double>(begin: 0, end: widget.from * -1).animate(CurvedAnimation(
        curve: const Interval(0, 0.35, curve: Curves.easeInOut), parent: controller!));
...
class _FlashState extends State<Flash> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    opacityOut1 = Tween<double>(begin: 1, end: 0)
        .animate(CurvedAnimation(parent: controller!, curve: const Interval(0, 0.25)));
    opacityIn1 = Tween<double>(begin: 0, end: 1)
        .animate(CurvedAnimation(parent: controller!, curve: const Interval(0.25, 0.5)));
    opacityOut2 = Tween<double>(begin: 1, end: 0)
        .animate(CurvedAnimation(parent: controller!, curve: const Interval(0.5, 0.75)));
    opacityIn2 = Tween<double>(begin: 0, end: 1)
        .animate(CurvedAnimation(parent: controller!, curve: const Interval(0.75, 1)));
...
class _PulseState extends State<Pulse> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    animationDec = Tween<double>(begin: 1.5, end: 1).animate(CurvedAnimation(
        parent: controller!, curve: const Interval(0.5, 1, curve: Curves.easeIn)));
...
class _SwingState extends State<Swing> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    animationRotation1 = Tween<double>(begin: 0, end: -0.5).animate(CurvedAnimation(
        parent: controller!, curve: const Interval(0, 0.1666, curve: Curves.easeOut)));

    animationRotation2 = Tween<double>(begin: -0.5, end: 0.5).animate(CurvedAnimation(
        parent: controller!,
        curve: const Interval(0.1666, 0.3333, curve: Curves.easeInOut)));

    animationRotation3 = Tween<double>(begin: 0.5, end: -0.5).animate(CurvedAnimation(
        parent: controller!,
        curve: const Interval(0.3333, 0.4999, curve: Curves.easeInOut)));

    animationRotation4 = Tween<double>(begin: -0.5, end: 0.4).animate(CurvedAnimation(
        parent: controller!,
        curve: const Interval(0.4999, 0.6666, curve: Curves.easeInOut)));

    animationRotation5 = Tween<double>(begin: 0.4, end: -0.4).animate(CurvedAnimation(
        parent: controller!,
        curve: const Interval(0.6666, 0.8333, curve: Curves.easeInOut)));

    animationRotation6 = Tween<double>(begin: -0.4, end: 0).animate(CurvedAnimation(
        parent: controller!, curve: const Interval(0.8333, 1, curve: Curves.easeOut)));
...
class _DanceState extends State<Dance> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    step1 = Tween<double>(begin: 0, end: -0.2).animate(CurvedAnimation(
        parent: controller!, curve: const Interval(0, 0.3333, curve: Curves.bounceOut)));
    ...
    step3 = Tween<double>(begin: 0.2, end: 0).animate(CurvedAnimation(
        parent: controller!, curve: const Interval(0.6666, 1, curve: Curves.bounceOut)));
