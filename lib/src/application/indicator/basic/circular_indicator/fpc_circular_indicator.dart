...
class FPCCircularIndicator extends FPCPlatformWidget {
  FPCCircularIndicator({
    super.key,
    required Color color,
    required double height,
  }) : super(
          cupertino: _FPCCircularIndicatorCupertino(
            key: key,
            color: color,
            height: height,
          ),
...
class _FPCCircularIndicatorCupertino extends StatelessWidget {
  const _FPCCircularIndicatorCupertino({
    super.key,
    required this.color,
