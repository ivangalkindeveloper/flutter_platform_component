...
class FPCSecondaryLightGradientPageIndicator extends StatelessWidget {
  const FPCSecondaryLightGradientPageIndicator({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return FPCGradientPageIndicator(
      ...
      selectedGradident: theme.secondaryLightGradient,
      height: this.height,
