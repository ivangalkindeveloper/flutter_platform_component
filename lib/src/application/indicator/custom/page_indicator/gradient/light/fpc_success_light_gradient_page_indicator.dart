...
class FPCSuccessLightGradientPageIndicator extends StatelessWidget {
  const FPCSuccessLightGradientPageIndicator({
    super.key,
  ...
  Widget build(
    ...
    return FPCGradientPageIndicator(
      ...
      selectedGradident: theme.successLightGradient,
      height: this.height,
