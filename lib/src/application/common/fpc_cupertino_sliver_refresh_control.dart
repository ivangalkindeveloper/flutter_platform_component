...
/// adds a  item to the top of the list view.
///
...
///    scrollable space.
class FPCCupertinoSliverRefreshControl extends StatefulWidget {
  ...
  /// a refresh.
  const FPCCupertinoSliverRefreshControl({
    super.key,
    this.color,
  ...
  @override
  State<FPCCupertinoSliverRefreshControl> createState() =>
      _FPCCupertinoSliverRefreshControlState();
}

class _FPCCupertinoSliverRefreshControlState
    extends State<FPCCupertinoSliverRefreshControl> {
