...
class FPCDangerDarkGradientSegmentControl<T> extends StatelessWidget {
  const FPCDangerDarkGradientSegmentControl({
    super.key,
    required this.value,
  ...
  Widget build(
    ...
    return FPCGradientSegmentControl(
      ...
      unselectedInternalGradient: theme.dangerDarkGradient,
