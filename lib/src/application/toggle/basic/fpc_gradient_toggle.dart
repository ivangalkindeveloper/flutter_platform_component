...
class FPCGradientToggle<T> extends StatefulWidget {
  ...
  @override
  State<FPCGradientToggle<T>> createState() => _FPCGradientToggleState<T>();
}

class _FPCGradientToggleState<T> extends State<FPCGradientToggle<T>> {
