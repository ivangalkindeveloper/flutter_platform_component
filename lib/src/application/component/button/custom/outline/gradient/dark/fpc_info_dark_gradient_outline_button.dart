...
class FPCInfoDarkGradientOutlineButton extends StatelessWidget {
  const FPCInfoDarkGradientOutlineButton({
    super.key,
    this.height,
    this.borderRadius,
    this.padding,
  ...
  Widget build(
    ...
    return FPCGradientOutlineButton(
      backgroundGradient: this.isFilled ? theme.infoGradient : null,
      splashColor: theme.infoDark,
      height: this.height,
      borderRadius: this.borderRadius,
      borderGradient: theme.infoDarkGradient,
      ...
      child: FPCAnimatedOpacityStack(
        ...
        firstChild: const FPCInfoDarkGradientCircularIndicator(),
        secondChild: FPCButtonRowChild(
          ...
          prefix: this.prefix,
          prefixIcon: null,
          titleGradient: theme.infoDarkGradient,
          title: this.title,
          textAlign: TextAlign.center,
          titleStyle: this.titleStyle?.copyWith(
                    color: this.titleStyle?.color ?? theme.infoDark,
                    fontWeight:
