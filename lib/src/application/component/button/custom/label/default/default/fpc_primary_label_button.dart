...
class FPCPrimaryLabelButton extends StatelessWidget {
  const FPCPrimaryLabelButton({
    super.key,
    this.height,
    this.borderRadius,
    this.padding,
  ...
  Widget build(
    ...
    return FPCButton(
      backgroundColor: this.isFilled ? theme.primaryLight : Colors.transparent,
      ...
      child: FPCAnimatedOpacityStack(
        ...
        firstChild: const FPCPrimaryCircularIndicator(),
