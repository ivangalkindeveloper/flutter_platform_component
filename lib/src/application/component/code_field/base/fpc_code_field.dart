...
class FPCCodeField extends StatefulWidget {
  const FPCCodeField({
    super.key,
    this.controller,
  ...
  @override
  State<FPCCodeField> createState() => _FPCCodeFieldState();
}

class _FPCCodeFieldState extends State<FPCCodeField>
    with TickerProviderStateMixin, FPCDidInitMixin<FPCCodeField> {
