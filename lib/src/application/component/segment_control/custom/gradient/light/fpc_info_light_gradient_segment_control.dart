...
class FPCInfoLightGradientSegmentControl<T> extends StatelessWidget {
  const FPCInfoLightGradientSegmentControl({
    super.key,
    required this.value,
  ...
  Widget build(
    ...
    return FPCGradientSegmentControl(
      ...
      unselectedBorderGradient: theme.infoLightGradient,
      unselectedInternalGradient: theme.infoLightGradient,
      unselectedSplashColor: theme.infoLight,
      unselectedStyle: this.unselectedStyle,
      selectedBackgroundGradient: theme.infoLightGradient,
      selectedBorderGradient: theme.infoLightGradient,
