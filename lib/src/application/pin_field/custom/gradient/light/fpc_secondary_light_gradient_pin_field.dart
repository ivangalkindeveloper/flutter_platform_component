...
class FPCSecondaryLightGradientPINField extends StatelessWidget {
  const FPCSecondaryLightGradientPINField({
    super.key,
    this.controller,
  ...
  Widget build(BuildContext context) {
    ...
    return FPCBasicGradientPINField(
      ...
      submittedBackgroundGradient: theme.secondaryLightGradient,
      height: this.height,
