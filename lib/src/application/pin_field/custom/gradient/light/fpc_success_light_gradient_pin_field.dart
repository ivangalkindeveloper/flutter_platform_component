...
class FPCSuccessLightGradientPINField extends StatelessWidget {
  const FPCSuccessLightGradientPINField({
    super.key,
    this.controller,
  ...
  Widget build(
    ...
    return FPCGradientPINField(
      ...
      focusedBorderColor: theme.successLight,
      submittedBackgroundGradient: theme.successLightGradient,
      height: this.height,
