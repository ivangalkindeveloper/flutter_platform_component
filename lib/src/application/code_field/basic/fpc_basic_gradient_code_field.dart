...
class FPCBasicGradientCodeField extends StatefulWidget {
  const FPCBasicGradientCodeField({
    super.key,
    this.controller,
...
class _FPCBasicGradientCodeFieldState extends State<FPCBasicGradientCodeField>
  ...
  @override
  void didUpdateWidget(covariant FPCBasicGradientCodeField oldWidget) {
