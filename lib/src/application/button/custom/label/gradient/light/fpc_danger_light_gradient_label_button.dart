...
class FPCDangerLightGradientLabelButton extends StatelessWidget {
  const FPCDangerLightGradientLabelButton({
    super.key,
    this.height,
    this.borderRadius,
    this.padding,
  ...
  Widget build(BuildContext context) {
    ...
    return FPCBasicGradientButton(
      ...
      child: FPCAnimatedOpacityStack(
        ...
        firstChild: FPCCircularIndicator.dangerLight(context),
