...
class FPCSuccessGradientLabelButton extends StatelessWidget {
  const FPCSuccessGradientLabelButton({
    super.key,
    this.height,
    this.borderRadius,
    this.padding,
  ...
  Widget build(BuildContext context) {
    ...
    return FPCGradientButton(
      ...
      child: FPCAnimatedOpacityStack(
        ...
        firstChild: const FPCSuccessCircularIndicator(),
        secondChild: FPCButtonRowChild(
          ...
          prefix: this.prefix,
          prefixIcon: null,
          titleGradient: theme.successGradient,
          title: this.title,
