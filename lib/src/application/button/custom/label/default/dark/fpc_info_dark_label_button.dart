...
class FPCInfoDarkLabelButton extends StatelessWidget {
  const FPCInfoDarkLabelButton({
    super.key,
    this.height,
    this.borderRadius,
    this.padding,
  ...
  Widget build(BuildContext context) {
    ...
    return FPCBasicButton(
      backgroundColor: this.isFilled ? theme.info : Colors.transparent,
      ...
      child: FPCAnimatedOpacityStack(
        ...
        firstChild: FPCCircularIndicator.infoDark(context),
