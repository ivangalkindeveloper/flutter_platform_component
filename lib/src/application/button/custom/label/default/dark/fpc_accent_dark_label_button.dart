...
class FPCAccentDarkLabelButton extends StatelessWidget {
  const FPCAccentDarkLabelButton({
    super.key,
    this.height,
    this.borderRadius,
    this.padding,
  ...
  Widget build(BuildContext context) {
    ...
    return FPCButton(
      backgroundColor: this.isFilled ? theme.accent : Colors.transparent,
      ...
      child: FPCAnimatedOpacityStack(
        ...
        firstChild: const FPCAccentDarkCircularIndicator(),
