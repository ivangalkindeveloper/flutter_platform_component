...
class FPCSuccessDarkLabelButton extends StatelessWidget {
  const FPCSuccessDarkLabelButton({
    super.key,
    this.height,
    this.borderRadius,
    this.padding,
  ...
  Widget build(BuildContext context) {
    ...
    return FPCBasicButton(
      backgroundColor: this.isFilled ? theme.success : Colors.transparent,
      ...
      child: FPCAnimatedOpacityStack(
        ...
        firstChild: FPCCircularIndicator.successDark(context),
