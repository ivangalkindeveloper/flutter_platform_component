...
class FPCSecondaryDarkLabelButton extends StatelessWidget {
  const FPCSecondaryDarkLabelButton({
    super.key,
    this.height,
    this.borderRadius,
    this.padding,
  ...
  Widget build(BuildContext context) {
    ...
    return FPCBasicButton(
      backgroundColor: this.isFilled ? theme.secondary : Colors.transparent,
      ...
      child: FPCAnimatedOpacityStack(
        ...
        firstChild: FPCCircularIndicator.secondaryDark(context),
