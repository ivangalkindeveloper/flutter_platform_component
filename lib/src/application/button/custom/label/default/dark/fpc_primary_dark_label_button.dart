...
class FPCPrimaryDarkLabelButton extends StatelessWidget {
  const FPCPrimaryDarkLabelButton({
    super.key,
    this.height,
    this.borderRadius,
    this.padding,
  ...
  Widget build(BuildContext context) {
    ...
    return FPCBasicButton(
      backgroundColor: this.isFilled ? theme.primary : Colors.transparent,
      ...
      child: FPCAnimatedOpacityStack(
        ...
        firstChild: FPCCircularIndicator.primaryDark(context),
