...
class FPCAccentGradientOutlineButton extends StatelessWidget {
  const FPCAccentGradientOutlineButton({
    super.key,
    this.height,
    this.borderRadius,
    this.padding,
  ...
  Widget build(BuildContext context) {
    ...
    return FPCGradientOutlineButton(
      filledGradient: this.isFilled ? theme.accentLightGradient : null,
      ...
      child: FPCAnimatedOpacityStack(
        ...
        firstChild: const FPCAccentGradientCircularIndicator(),
        secondChild: FPCButtonRowChild(
          ...
          prefix: this.prefix,
          prefixIcon: null,
          titleGradient: theme.accentGradient,
          title: this.title,
