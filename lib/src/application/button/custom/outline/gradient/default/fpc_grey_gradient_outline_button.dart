...
class FPCGreyGradientOutlineButton extends StatelessWidget {
  const FPCGreyGradientOutlineButton({
    super.key,
    this.height,
    this.borderRadius,
    this.padding,
  ...
  Widget build(BuildContext context) {
    ...
    return FPCGradientOutlineButton(
      filledGradient: this.isFilled ? theme.greyLightGradient : null,
      ...
      child: FPCAnimatedOpacityStack(
        ...
        firstChild: const FPCGreyGradientCircularIndicator(),
        secondChild: FPCButtonRowChild(
          ...
          prefix: this.prefix,
          prefixIcon: null,
          titleGradient: theme.greyGradient,
          title: this.title,
