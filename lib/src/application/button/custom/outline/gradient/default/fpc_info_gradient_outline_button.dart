...
class FPCInfoGradientOutlineButton extends StatelessWidget {
  const FPCInfoGradientOutlineButton({
    super.key,
    this.height,
    this.borderRadius,
    this.padding,
  ...
  Widget build(BuildContext context) {
    ...
    return FPCGradientOutlineButton(
      filledGradient: this.isFilled ? theme.infoLightGradient : null,
      splashColor: theme.info,
      height: this.height,
      borderRadius: this.borderRadius,
      borderGradient: theme.infoGradient,
      ...
      child: FPCAnimatedOpacityStack(
        ...
        firstChild: const FPCInfoGradientCircularIndicator(),
