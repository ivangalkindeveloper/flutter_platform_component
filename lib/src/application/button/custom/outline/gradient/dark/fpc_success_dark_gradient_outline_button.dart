...
class FPCSuccessDarkGradientOutlineButton extends StatelessWidget {
  const FPCSuccessDarkGradientOutlineButton({
    super.key,
    this.height,
    this.borderRadius,
    this.padding,
  ...
  Widget build(BuildContext context) {
    ...
    return FPCGradientOutlineButton(
      backgroundGradient: this.isFilled ? theme.successGradient : null,
      splashColor: theme.successDark,
      height: this.height,
      borderRadius: this.borderRadius,
      borderGradient: theme.successDarkGradient,
      ...
      child: FPCAnimatedOpacityStack(
        ...
        firstChild: const FPCSuccessDarkGradientCircularIndicator(),
        secondChild: FPCButtonRowChild(
          ...
          prefix: this.prefix,
          prefixIcon: null,
          titleGradient: theme.successDarkGradient,
          title: this.title,
