...
class FPCPrimaryDarkGradientOutlineButton extends StatelessWidget {
  const FPCPrimaryDarkGradientOutlineButton({
    super.key,
    this.height,
    this.borderRadius,
    this.padding,
  ...
  Widget build(
    ...
    return FPCGradientOutlineButton(
      backgroundGradient: this.isFilled ? theme.primaryGradient : null,
      splashColor: theme.primaryDark,
      height: this.height,
      borderRadius: this.borderRadius,
      borderGradient: theme.primaryDarkGradient,
      ...
      child: FPCAnimatedOpacityStack(
        ...
        firstChild: const FPCPrimaryDarkGradientCircularIndicator(),
        secondChild: FPCButtonRowChild(
          ...
          prefix: this.prefix,
          prefixIcon: null,
          titleGradient: theme.primaryDarkGradient,
          title: this.title,
          textAlign: TextAlign.center,
          titleStyle: this.titleStyle?.copyWith(
                    color: this.titleStyle?.color ?? theme.primaryDark,
