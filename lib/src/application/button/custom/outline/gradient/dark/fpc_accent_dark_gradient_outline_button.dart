...
class FPCAccentDarkGradientOutlineButton extends StatelessWidget {
  const FPCAccentDarkGradientOutlineButton({
    super.key,
    this.height,
    this.borderRadius,
    this.padding,
  ...
  Widget build(
    ...
    return FPCGradientOutlineButton(
      backgroundGradient: this.isFilled ? theme.accentGradient : null,
      splashColor: theme.accentDark,
      height: this.height,
      borderRadius: this.borderRadius,
      borderGradient: theme.accentDarkGradient,
      ...
      child: FPCAnimatedOpacityStack(
        ...
        firstChild: const FPCAccentDarkGradientCircularIndicator(),
