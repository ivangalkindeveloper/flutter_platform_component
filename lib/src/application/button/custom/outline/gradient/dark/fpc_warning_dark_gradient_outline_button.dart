...
class FPCWarningDarkGradientOutlineButton extends StatelessWidget {
  const FPCWarningDarkGradientOutlineButton({
    super.key,
    this.height,
    this.borderRadius,
    this.padding,
  ...
  Widget build(
    ...
    return FPCGradientOutlineButton(
      backgroundGradient: this.isFilled ? theme.warningGradient : null,
      splashColor: theme.warningDark,
      height: this.height,
      borderRadius: this.borderRadius,
      borderGradient: theme.warningDarkGradient,
      ...
      child: FPCAnimatedOpacityStack(
        ...
        firstChild: const FPCWarningDarkGradientCircularIndicator(),
        secondChild: FPCButtonRowChild(
          ...
          prefix: this.prefix,
          prefixIcon: null,
          titleGradient: theme.warningDarkGradient,
          title: this.title,
          textAlign: TextAlign.center,
          titleStyle: this.titleStyle?.copyWith(
                    color: this.titleStyle?.color ?? theme.warningDark,
