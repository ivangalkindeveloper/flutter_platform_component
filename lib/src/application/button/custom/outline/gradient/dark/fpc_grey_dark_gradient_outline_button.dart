...
class FPCGreyDarkGradientOutlineButton extends StatelessWidget {
  const FPCGreyDarkGradientOutlineButton({
    super.key,
    this.height,
    this.borderRadius,
    this.padding,
  ...
  Widget build(
    ...
    return FPCGradientOutlineButton(
      backgroundGradient: this.isFilled ? theme.greyGradient : null,
      splashColor: theme.greyDark,
      height: this.height,
      borderRadius: this.borderRadius,
      borderGradient: theme.greyDarkGradient,
      ...
      child: FPCAnimatedOpacityStack(
        ...
        firstChild: const FPCGreyDarkGradientCircularIndicator(),
        secondChild: FPCButtonRowChild(
          ...
          prefix: this.prefix,
          prefixIcon: null,
          titleGradient: theme.greyDarkGradient,
          title: this.title,
