...
class FPCDangerDarkGradientOutlineButton extends StatelessWidget {
  const FPCDangerDarkGradientOutlineButton({
    super.key,
    this.height,
    this.borderRadius,
    this.padding,
  ...
  Widget build(
    ...
    return FPCGradientOutlineButton(
      backgroundGradient: this.isFilled ? theme.dangerGradient : null,
      splashColor: theme.dangerDark,
      height: this.height,
      borderRadius: this.borderRadius,
      borderGradient: theme.dangerDarkGradient,
      ...
      child: FPCAnimatedOpacityStack(
        ...
        firstChild: const FPCDangerDarkGradientCircularIndicator(),
        secondChild: FPCButtonRowChild(
          ...
          prefix: this.prefix,
          prefixIcon: null,
          titleGradient: theme.dangerDarkGradient,
          title: this.title,
          textAlign: TextAlign.center,
          titleStyle: this.titleStyle?.copyWith(
                    color: this.titleStyle?.color ?? theme.dangerDark,
