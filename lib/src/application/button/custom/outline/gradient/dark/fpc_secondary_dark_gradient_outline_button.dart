...
class FPCSecondaryDarkGradientOutlineButton extends StatelessWidget {
  const FPCSecondaryDarkGradientOutlineButton({
    super.key,
    this.height,
    this.borderRadius,
    this.padding,
  ...
  Widget build(BuildContext context) {
    ...
    return FPCGradientOutlineButton(
      backgroundGradient: this.isFilled ? theme.secondaryGradient : null,
      splashColor: theme.secondaryDark,
      height: this.height,
      borderRadius: this.borderRadius,
      borderGradient: theme.secondaryDarkGradient,
      ...
      child: FPCAnimatedOpacityStack(
        ...
        firstChild: const FPCSecondaryDarkGradientCircularIndicator(),
        secondChild: FPCButtonRowChild(
          ...
          prefix: this.prefix,
          prefixIcon: null,
          titleGradient: theme.secondaryDarkGradient,
          title: this.title,
