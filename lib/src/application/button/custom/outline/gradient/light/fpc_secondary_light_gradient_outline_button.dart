...
class FPCSecondaryLightGradientOutlineButton extends StatelessWidget {
  const FPCSecondaryLightGradientOutlineButton({
    super.key,
    this.height,
    this.borderRadius,
    this.padding,
  ...
  Widget build(BuildContext context) {
    ...
    return FPCBasicGradientOutlineButton(
      ...
      borderGradient: theme.secondaryLightGradient,
      ...
      child: FPCAnimatedOpacityStack(
        ...
        firstChild: FPCCircularIndicator.secondaryLightGradient(context),
