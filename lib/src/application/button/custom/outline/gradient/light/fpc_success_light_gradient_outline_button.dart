...
class FPCSuccessLightGradientOutlineButton extends StatelessWidget {
  const FPCSuccessLightGradientOutlineButton({
    super.key,
    this.height,
    this.borderRadius,
    this.padding,
  ...
  Widget build(BuildContext context) {
    ...
    return FPCBasicGradientOutlineButton(
      ...
      borderGradient: theme.successLightGradient,
      ...
      child: FPCAnimatedOpacityStack(
        ...
        firstChild: FPCCircularIndicator.successLightGradient(context),
