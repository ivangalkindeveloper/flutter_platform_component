...
class FPCAccentLightGradientOutlineButton extends StatelessWidget {
  const FPCAccentLightGradientOutlineButton({
    super.key,
    this.height,
    this.borderRadius,
    this.padding,
  ...
  Widget build(BuildContext context) {
    ...
    return FPCBasicGradientOutlineButton(
      ...
      borderGradient: theme.accentLightGradient,
      ...
      child: FPCAnimatedOpacityStack(
        ...
        firstChild: FPCCircularIndicator.accentLightGradient(context),
        secondChild: FPCButtonRowChild(
          ...
          prefix: this.prefix,
          prefixIcon: null,
          titleGradient: theme.accentLightGradient,
          title: this.title,
