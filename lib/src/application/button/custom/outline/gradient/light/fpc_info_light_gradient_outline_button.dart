...
class FPCInfoLightGradientOutlineButton extends StatelessWidget {
  const FPCInfoLightGradientOutlineButton({
    super.key,
    this.height,
    this.borderRadius,
    this.padding,
  ...
  Widget build(BuildContext context) {
    ...
    return FPCBasicGradientOutlineButton(
      splashColor: theme.infoLight,
      height: this.height,
      borderRadius: this.borderRadius,
      borderGradient: theme.infoLightGradient,
      ...
      child: FPCAnimatedOpacityStack(
        ...
        firstChild: FPCCircularIndicator.infoLightGradient(context),
        secondChild: FPCButtonRowChild(
          ...
          prefix: this.prefix,
          prefixIcon: null,
          titleGradient: theme.infoLightGradient,
          title: this.title,
          textAlign: TextAlign.center,
          titleStyle: this.titleStyle?.copyWith(
                    color: this.titleStyle?.color ?? theme.infoLight,
