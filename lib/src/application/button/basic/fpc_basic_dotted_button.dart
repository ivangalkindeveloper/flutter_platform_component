...
class FPCBasicDottedButton extends FPCPlatformWidget {
  FPCBasicDottedButton({
    ...
    required Widget child,
          ...
          cupertino: _FPCBasicDottedButtonCupertino(
            key: key,
          ...
          material: _FPCBasicDottedButtonMaterial(
            key: key,
            filledColor: filledColor,
            splashColor: splashColor,
            height: height,
...
class _FPCBasicDottedButtonCupertino extends StatelessWidget {
  const _FPCBasicDottedButtonCupertino({
    super.key,
...
class _FPCBasicDottedButtonMaterial extends StatelessWidget {
  const _FPCBasicDottedButtonMaterial({
    super.key,
    required this.filledColor,
    required this.splashColor,
    required this.height,
