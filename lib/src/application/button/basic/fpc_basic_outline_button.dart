...
class FPCBasicOutlineButton extends FPCPlatformWidget {
  FPCBasicOutlineButton({
    super.key,
    Color? filledColor,
    Color? splashColor,
    double? height,
    ...
    required Widget child,
          ...
          cupertino: _FPCBasicOutlineButtonCupertino(
            key: key,
          ...
          material: _FPCBasicOutlineButtonMaterial(
            key: key,
            filledColor: filledColor,
            splashColor: splashColor,
            height: height,
...
class _FPCBasicOutlineButtonCupertino extends StatelessWidget {
  const _FPCBasicOutlineButtonCupertino({
    super.key,
...
class _FPCBasicOutlineButtonMaterial extends StatelessWidget {
  const _FPCBasicOutlineButtonMaterial({
    super.key,
    required this.filledColor,
    required this.splashColor,
    required this.height,
