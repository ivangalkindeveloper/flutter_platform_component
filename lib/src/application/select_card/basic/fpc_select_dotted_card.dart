...
class FPCSelectDottedCard extends FPCPlatformWidget {
  FPCSelectDottedCard({
    super.key,
    ...
    required Widget child,
          ...
          cupertino: _FPCSelectDottedCardCupertino(
            key: key,
          ...
          material: _FPCSelectDottedCardMaterial(
            key: key,
            backgroundColor: backgroundColor,
            splashColor: splashColor,
            height: height,
...
class _FPCSelectDottedCardCupertino extends StatelessWidget {
  const _FPCSelectDottedCardCupertino({
    super.key,
...
class _FPCSelectDottedCardMaterial extends StatelessWidget {
  const _FPCSelectDottedCardMaterial({
    super.key,
    required this.backgroundColor,
    required this.splashColor,
    required this.height,
