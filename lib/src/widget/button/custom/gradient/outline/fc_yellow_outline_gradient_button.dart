...
class FCYellowOutlineGradientButton extends StatelessWidget {
  const FCYellowOutlineGradientButton({
    Key? key,
    this.prefix,
    this.prefixIcon,
    required this.title,
  ...
  Widget build(BuildContext context) {
    ...
    return FCBasicGradientButton(
      backgroundGradient: this.isFilled ? theme.yellowLightGradient : null,
      borderGradient: theme.yellowGradient,
      splashColor: theme.yellow,
      child: FCAnimatedOpacityStack(
        condition: this.isLoading,
        firstChild: FCCircularIndicator.yellow(context: context),
        secondChild: Row(
