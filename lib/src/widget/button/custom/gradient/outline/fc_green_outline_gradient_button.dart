...
class FCGreenOutlineGradientButton extends StatelessWidget {
  const FCGreenOutlineGradientButton({
    super.key,
    this.prefix,
    this.prefixIcon,
    required this.title,
  ...
  Widget build(BuildContext context) {
    ...
    return FCBasicGradientButton(
      backgroundGradient: this.isFilled ? theme.greenLightGradient : null,
      borderGradient: theme.greenGradient,
