...
class FCYellowOutlineButton extends StatelessWidget {
  const FCYellowOutlineButton({
    super.key,
    this.prefix,
    this.prefixIcon,
    required this.title,
  ...
  Widget build(BuildContext context) {
    ...
    return FCBasicButton(
      backgroundColor: this.isFilled ? theme.yellowLight : null,
