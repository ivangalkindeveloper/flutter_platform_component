...
class FCBasicGradientSlowShimmer extends StatefulWidget {
  const FCBasicGradientSlowShimmer({
    Key? key,
  ...
  @override
  State<FCBasicGradientSlowShimmer> createState() => _FCBasicGradientSlowShimmerState();
}

class _FCBasicGradientSlowShimmerState extends State<FCBasicGradientSlowShimmer> {
