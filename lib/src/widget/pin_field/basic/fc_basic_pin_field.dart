...
class _FCBasicPINFieldState extends State<FCBasicPINField>
    with TickerProviderStateMixin, FCDidInitMixin<FCBasicPINField> {
  ...
  @override
  void didUpdateWidget(covariant FCBasicPINField oldWidget) {
