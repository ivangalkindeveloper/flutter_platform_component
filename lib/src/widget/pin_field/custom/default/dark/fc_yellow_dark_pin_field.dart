...
class FCYellowDarkPINField extends StatelessWidget {
  const FCYellowDarkPINField({
    Key? key,
  ...
  Widget build(BuildContext context) {
    ...
    return FCBasicPINField(
      ...
      focusedBorderColor: theme.yellowDark,
      submittedBackgroundColor: theme.yellowDark,
