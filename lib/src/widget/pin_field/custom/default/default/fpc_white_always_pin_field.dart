...
class FPCWhiteAlwaysPINField extends StatelessWidget {
  const FPCWhiteAlwaysPINField({
    super.key,
    this.controller,
  ...
  Widget build(BuildContext context) {
    ...
    return FPCBasicPINField(
      ...
      focusedBorderColor: theme.whiteAlways,
      submittedBackgroundColor: theme.whiteAlways,
      height: this.height,
