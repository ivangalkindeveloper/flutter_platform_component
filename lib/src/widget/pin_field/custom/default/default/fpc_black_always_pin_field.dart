...
class FPCBlackAlwaysPINField extends StatelessWidget {
  const FPCBlackAlwaysPINField({
    super.key,
    this.controller,
  ...
  Widget build(BuildContext context) {
    ...
    return FPCBasicPINField(
      ...
      focusedBorderColor: theme.blackAlways,
      submittedBackgroundColor: theme.blackAlways,
      height: this.height,
