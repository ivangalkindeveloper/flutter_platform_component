...
class FPCPrimaryLightGradientPINField extends StatelessWidget {
  const FPCPrimaryLightGradientPINField({
    super.key,
    this.controller,
  ...
  Widget build(BuildContext context) {
    ...
    return FPCBasicGradientPINField(
      ...
      submittedBackgroundGradient: theme.primaryLightGradient,
      height: this.height,
