...
class FCYellowLightGradientPINField extends StatelessWidget {
  const FCYellowLightGradientPINField({
    Key? key,
  ...
  Widget build(BuildContext context) {
    ...
    return FCBasicGradientPINField(
      ...
      focusedBorderColor: theme.yellowLight,
      submittedBackgroundGradient: theme.yellowLightGradient,
