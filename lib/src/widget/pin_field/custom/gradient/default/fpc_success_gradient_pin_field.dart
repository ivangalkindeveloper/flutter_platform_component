...
class FPCSuccessGradientPINField extends StatelessWidget {
  const FPCSuccessGradientPINField({
    super.key,
    this.controller,
  ...
  Widget build(BuildContext context) {
    ...
    return FPCBasicGradientPINField(
      ...
      focusedBorderColor: theme.success,
      submittedBackgroundGradient: theme.successGradient,
      height: this.height,
