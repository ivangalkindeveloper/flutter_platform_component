...
class FCGreenGradientPINField extends StatelessWidget {
  const FCGreenGradientPINField({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return FCBasicGradientPINField(
      ...
      focusedBorderColor: theme.green,
      submittedBackgroundGradient: theme.greenGradient,
