...
class FCYellowGradientPINField extends StatelessWidget {
  const FCYellowGradientPINField({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return FCBasicGradientPINField(
      ...
      focusedBorderColor: theme.yellow,
      submittedBackgroundGradient: theme.yellowGradient,
