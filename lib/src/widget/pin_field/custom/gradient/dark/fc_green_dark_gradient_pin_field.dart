...
class FCGreenDarkGradientPINField extends StatelessWidget {
  const FCGreenDarkGradientPINField({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return FCBasicGradientPINField(
      ...
      focusedBorderColor: theme.greenDark,
      submittedBackgroundGradient: theme.greenDarkGradient,
