...
class FPCWarningLightSegmentControl<T> extends StatelessWidget {
  const FPCWarningLightSegmentControl({
    super.key,
    required this.value,
    required this.items,
  ...
  Widget build(BuildContext context) {
    ...
    return FPCBasicSegmentControl(
      ...
      unselectedBorderColor: theme.warningLight,
      unselectedInternalColor: theme.warningLight,
      unselectedSplashColor: theme.warningLight,
      unselectedStyle: this.unselectedStyle,
      selectedBackgroundColor: theme.warningLight,
      selectedBorderColor: theme.warningLight,
