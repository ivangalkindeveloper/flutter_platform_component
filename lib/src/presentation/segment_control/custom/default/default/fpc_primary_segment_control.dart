...
class FPCPrimarySegmentControl<T> extends StatelessWidget {
  const FPCPrimarySegmentControl({
    super.key,
    required this.value,
    required this.items,
  ...
  Widget build(BuildContext context) {
    ...
    return FPCBasicSegmentControl(
      ...
      unselectedBorderColor: theme.primary,
      unselectedInternalColor: theme.primary,
