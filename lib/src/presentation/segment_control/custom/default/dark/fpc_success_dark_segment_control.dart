...
class FPCSuccessDarkSegmentControl<T> extends StatelessWidget {
  const FPCSuccessDarkSegmentControl({
    super.key,
    required this.value,
    required this.items,
  ...
  Widget build(BuildContext context) {
    ...
    return FPCBasicSegmentControl(
      ...
      unselectedBorderColor: theme.successDark,
      ...
      selectedBorderColor: theme.successDark,
