...
class _FPCAppCupertino extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CupertinoApp(
      ...
      //
      theme:
          this.cupertinoThemeData ?? context.componentTheme.cupertinoThemeData,
      locale: this.locale,
      localizationsDelegates: [
        DefaultWidgetsLocalizations.delegate,
        DefaultCupertinoLocalizations.delegate,
...
class _FPCAppMaterial extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      //
      themeMode:
          this.materialThemeMode ?? context.componentTheme.materialThemeMode,
      theme: this.materialThemeData ?? context.componentTheme.materialThemeData,
      locale: this.locale,
      localizationsDelegates: [
        DefaultWidgetsLocalizations.delegate,
        DefaultCupertinoLocalizations.delegate,
